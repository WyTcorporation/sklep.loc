                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <div class="input-group">
                                                ...
                                                <button onclick="addProducts($('#products').select2('data')[0].id,$('#products').select2('data')[0].text);" id="add-products" class="form-control btn-success" type="button">Add</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
