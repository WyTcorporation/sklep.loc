...
<div class="content">
    <div class="box card">
        <form role="form" enctype="multipart/form-data" method="post"
              action="{{ route('news.update',['news' => $item->id ]) }}">
            @csrf
            @method('PUT')
