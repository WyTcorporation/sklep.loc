...
<div class="content">
    <div class="box card">
        <form role="form" enctype="multipart/form-data" method="post" action="{{ route('products.store') }}">
            @csrf
            @method('POST')
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="custom-tabs-one-tabContent">
                            ...
                            <div class="tab-pane fade" id="custom-tabs-one-configs" role="tabpanel"
                                ...
                                <fieldset class="mb-3">
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-2">{{__('fields.Top.Title')}}</label>
                                        <div class="col-lg-10">
                                            <input type="checkbox" name="new" data-bootstrap-switch>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-2">{{__('fields.Hit.Title')}}</label>
                                        <div class="col-lg-10">
                                            <input type="checkbox" name="hit" data-bootstrap-switch
