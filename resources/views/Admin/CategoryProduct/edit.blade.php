...
<div class="content">
    <div class="box card">
        <form role="form" enctype="multipart/form-data" method="post"
              action="{{ route('products.categories.update',['category_product'=>$item->id ]) }}">
            @csrf
            @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label"
                                                       for="exampleInputFile">{{ $item->icon ?? __('fields.ChooseFile.Title') }}</label>
                                            </div>
                                        ...
                                        @if($item->icon)
                                            <img width="250px" src="/{{$item->icon}}" alt="{{ $item->alt ?? "" }}">
                                        @endif
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label"
                                                       for="exampleInputFile">{{__('fields.ChooseFile.Title')}}</label>
                                                <label class="custom-file-label"
                                                       for="exampleInputFile">{{ $item->src ?? __('fields.ChooseFile.Title') }}</label>
                                            </div>
                                            <div class="input-group-append">
                                                <span class="input-group-text">{{__('fields.Upload.Title')}}</span>
                                            </div>
